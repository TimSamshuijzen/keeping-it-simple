...
description: Prefer the simplest solution that works, YAGNI, no speculative abstraction, no over-engineering. Use this skill when making a design choice, or when writing or modifying code, or when asked to keep it simple.
---
